...
struct GrafanaDashboard: Codable, Sendable, Equatable {
    ...
    enum CodingKeys: String, CodingKey {
        case annotations, editable, fiscalYearStartMonth, graphTooltip, id, links, liveNow
        case panels, refresh, schemaVersion, style, tags, templating, time, timepicker
        case timezone, title, uid, version, weekStart, description
    }
}
...
struct AnnotationsBox: Codable, Sendable, Equatable {
    var list: [String] = []
}

struct TemplatingBox: Codable, Sendable, Equatable {
    var list: [TemplateVariable]
}

struct DashboardTimeRange: Codable, Sendable, Equatable {
    var from: String
    var to: String
}
...
enum TemplateVariable: Codable, Sendable, Equatable {
...
struct DatasourceTemplateVariable: Codable, Sendable, Equatable {
...
struct QueryTemplateVariable: Codable, Sendable, Equatable {
    var allValue: String?
...
struct TemplateCurrent: Codable, Sendable, Equatable {
    var selected: Bool?
    var text: String
    var value: String
}

// MARK: - Datasource & targets

struct DatasourceRef: Codable, Sendable, Equatable {
    var type: String
    var uid: String
}

struct QueryTarget: Codable, Sendable, Equatable {
    var datasource: DatasourceRef
...
struct GridPos: Codable, Sendable, Equatable {
    var h: Int
    var w: Int
    var x: Int
    var y: Int
...
struct PanelLink: Codable, Sendable, Equatable {
    var title: String
    var type: String?
    var url: String
...
struct FieldLink: Codable, Sendable, Equatable {
    var title: String
    var url: String
    var targetBlank: Bool = false
}

struct ColorMode: Codable, Sendable, Equatable {
    var mode: String
}

// MARK: - Stat panel

struct StatFieldDefaults: Codable, Sendable, Equatable {
    var unit: String
    var links: [FieldLink]?
}

struct StatFieldConfig: Codable, Sendable, Equatable {
    var defaults: StatFieldDefaults
    var overrides: [EmptyObject] = []
}

struct StatReduceOptions: Codable, Sendable, Equatable {
    var calcs: [String]
    var fields: String
    var values: Bool
}

struct StatOptions: Codable, Sendable, Equatable {
...
struct StatPanel: Codable, Sendable, Equatable {
    var datasource: DatasourceRef
...
struct TSFieldCustom: Codable, Sendable, Equatable {
...
struct TSFieldDefaults: Codable, Sendable, Equatable {
    var color: ColorMode
...
struct TSFieldConfig: Codable, Sendable, Equatable {
    var defaults: TSFieldDefaults
    var overrides: [EmptyObject] = []
}

struct TSLegend: Codable, Sendable, Equatable {
    var displayMode: String
    var placement: String
}

struct TSTooltip: Codable, Sendable, Equatable {
    var mode: String
}

struct TSOptions: Codable, Sendable, Equatable {
    var legend: TSLegend
    var tooltip: TSTooltip
}

struct TimeseriesPanel: Codable, Sendable, Equatable {
    var datasource: DatasourceRef
...
struct TableFieldConfig: Codable, Sendable, Equatable {
    var defaults: TableFieldDefaults
    var overrides: [EmptyObject] = []
}

struct TableFieldDefaults: Codable, Sendable, Equatable {
    var links: [FieldLink]?
...
struct TableOptions: Codable, Sendable, Equatable {
    var cellHeight: String = "sm"
    var showHeader: Bool = true
    var sortBy: [String] = []
}

struct TablePanel: Codable, Sendable, Equatable {
    var datasource: DatasourceRef
...
struct BarChartOptions: Codable, Sendable, Equatable {
    var barRadius: Int = 0
...
struct BarChartPanel: Codable, Sendable, Equatable {
    var datasource: DatasourceRef
    var fieldConfig: TableFieldConfig
    var gridPos: GridPos
    var id: Int
...
struct TextCodeOptions: Codable, Sendable, Equatable {
    var language: String
    var showLineNumbers: Bool
}

struct TextPanelOptions: Codable, Sendable, Equatable {
    var code: TextCodeOptions
    var content: String
}

struct TextPanel: Codable, Sendable, Equatable {
    var gridPos: GridPos
    var id: Int
...
// MARK: - Heterogeneous panel

enum GrafanaPanel: Codable, Sendable, Equatable {
    case stat(StatPanel)
